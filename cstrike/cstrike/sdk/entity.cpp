...
// cHoca
void C_CSWeaponBase::UpdateModel(bool should)
{
    using fn = void(CS_FASTCALL*)(void*, bool );
    static auto composite = reinterpret_cast<fn>(MEM::FindPattern(CLIENT_DLL, CS_XOR("48 89 5C 24 10 48 89 6C 24 18 48 89 74 24 20 57 41 56 41 57 48 83 EC 20 44 0F B6 F2 48 8B F1 E8")));
    auto composite_material = reinterpret_cast<void*>(reinterpret_cast<std::uintptr_t>(this) + 0x550);

    return composite(composite_material, should);
}

...
#pragma region ragebot 
	...
	C_ADD_VARIABLE_ARRAY(int, 7, rage_silent_mode, 0);
	C_ADD_VARIABLE_ARRAY(bool, 7, hitbox_head, 0);
	C_ADD_VARIABLE_ARRAY(bool, 7, prefer_body, 0);
	...
	C_ADD_VARIABLE_ARRAY(float, 7, legit_smooth, 1);
	C_ADD_VARIABLE_ARRAY(bool, 7, legit_smoothing, 0);

	C_ADD_VARIABLE_ARRAY(int, 7, legit_target_select, 0);
	C_ADD_VARIABLE(bool, legit_enable, false);
	C_ADD_VARIABLE_ARRAY(float, 7, legit_fov, 0);

	C_ADD_VARIABLE_ARRAY(bool, 7, legit_rcs, 0);
	C_ADD_VARIABLE_ARRAY(float, 7, legit_rcs_x, 0);
	C_ADD_VARIABLE_ARRAY(float, 7, legit_rcs_y, 0);
	C_ADD_VARIABLE_ARRAY(bool, 7, legit_rcs_humanization, false);

	C_ADD_VARIABLE_ARRAY(bool, 7, legit_triggerbot, 0);

	C_ADD_VARIABLE_ARRAY(bool, 7, legit_silent, false);
	C_ADD_VARIABLE_ARRAY(bool, 7, perfect_silent, false);
...
#pragma region variables_visuals
	...
	C_ADD_VARIABLE(bool, bSkeletonLagComp, false);
	...
	C_ADD_VARIABLE(ColorPickerVar_t, colSkeletonBacktrack, ColorPickerVar_t(255, 0, 0));
...
#pragma endregion
	C_ADD_VARIABLE(KeyBind_t, legit_key, 0);
...
#pragma region variables_misc
	...
	C_ADD_VARIABLE(bool, bFOVScoped, false);

	C_ADD_VARIABLE(bool, bSetViewModelFOV, false);
	C_ADD_VARIABLE(bool, bSetViewModelFOVScoped, false);
	...
	C_ADD_VARIABLE(KeyBind_t, thirdperson_key, 0);

	C_ADD_VARIABLE(int, legit_key_style, 0);
...
#pragma region variables_menu
	...
	C_ADD_VARIABLE(unsigned int, nMenuKey, VK_F2);
	C_ADD_VARIABLE(unsigned int, nPanicKey, VK_F4);

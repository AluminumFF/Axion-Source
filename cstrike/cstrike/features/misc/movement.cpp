...
void F::MISC::MOVEMENT::impl::movment_fix(CUserCmd* pCmd, QAngle_t angle)
{
	QAngle_t wish_angle;
...
void F::MISC::MOVEMENT::impl::ProcessMovement(CUserCmd* pCmd, CCSPlayerController* pLocalController, C_CSPlayerPawn* pLocalPawn)
{
	if (!pLocalController)
		return;
	...
	movement->movment_fix(pCmd, _move_data.angStoredView);
...
void F::MISC::MOVEMENT::impl::EdgeBug(CCSPlayerController* controler, C_CSPlayerPawn* localPlayer, CUserCmd* cmd) {
...
void F::MISC::MOVEMENT::impl::AutoStrafe(CUserCmd* pCmd, CBaseUserCmdPB* pUserCmd, C_CSPlayerPawn* pLocalPawn, int type)
{
...
void F::MISC::MOVEMENT::impl::BunnyHop(CUserCmd* pCmd, CBaseUserCmdPB* pUserCmd, C_CSPlayerPawn* pLocalPawn)
{
...
void F::MISC::MOVEMENT::impl::ValidateUserCommand(CUserCmd* pCmd, CBaseUserCmdPB* pUserCmd, CCSGOInputHistoryEntryPB* pInputEntry)
{
	if (pUserCmd == nullptr)
		return;
...
void F::MISC::MOVEMENT::impl::MovementCorrection(CBaseUserCmdPB* pUserCmd, CCSGOInputHistoryEntryPB* pInputEntry, const QAngle_t& angDesiredViewPoint)
{
	if (pUserCmd == nullptr)
		return;
